...
local gears = require("gears")         -- Color parsing and objects
...
local hotkeys_popup = require("awful.hotkeys_popup")  -- Show hotkeys

require("awful.autofocus")             -- Focus related features
require("awful.hotkeys_popup.keys")    -- Show hotkeys
-- }}}
